  ...
  <xsl:template match="/page">
    ...
    <html>
      ...
      <body>
        <nav role="navigation">
          <ul style="text-align:left">
            <xsl:if test="identity">
              <li>
                <img src="{identity/avatar}" alt="profile picture of {identity/urn}" title="{identity/urn}" style="width:48px;height:48px;border-radius:50%;vertical-align:middle"/>
              </li>
              <li>
        ...
        <aside class="ico">
          <img src="//www.thindeck.com/1.png" style="width:96px;height:96px;" alt="thindeck logo"/>
        </aside>
      </body>
    </html>
  </xsl:template>
